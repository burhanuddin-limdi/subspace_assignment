...
class OnlineBlogs extends StatelessWidget {
  final _key = GlobalKey<ScaffoldState>();
  final BuildContext ctx;
  final List blogsData;
  OnlineBlogs({super.key, required this.ctx, required this.blogsData});
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return BlogCard(blogData: blogsData[index]);
                    },
                  )
                ],
              ),
